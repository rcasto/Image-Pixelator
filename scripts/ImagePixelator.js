...
Pixelator.game = (function () {
	...
	function addBackground() {
		...
		backgroundScene.add(backMesh);
	}
	*/

	//Adds drop image here, image to page
	function dropScreen() {
		var texture = THREE.ImageUtils.loadTexture("images/dropImage.png"),
			material = new THREE.MeshBasicMaterial({
				map: texture
			}),
    ...
    function init() {
		...
		particleTexture = THREE.ImageUtils.loadTexture("images/ball.png");
...
addLoadEvent(Pixelator.game.init);